...
Текущий эксперимент: [EXP-0001 — Direct Q&A over Zotero source HTML](experiments/EXP-0001-zotero-direct-qa/task.md). Корпус нормализован, gold-набор готов; следующий запуск должен выполняться без доступа runner к `gold.jsonl`.
