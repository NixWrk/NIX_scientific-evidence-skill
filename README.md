...
**Текущее состояние работы и точка входа для новой сессии:
[`docs/handoff.md`](docs/handoff.md).** Там записаны смысл работы, что уже
сделано, какие инварианты проверяются программой и что делать дальше.
